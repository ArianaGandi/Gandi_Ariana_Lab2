...
namespace Gandi_Ariana_Lab2.Data
{
    public class Gandi_Ariana_Lab2Context : DbContext
    {
        ...
        public DbSet<Gandi_Ariana_Lab2.Models.Category> Category { get; set; }

        public DbSet<Gandi_Ariana_Lab2.Models.Member> Member { get; set; }

        public DbSet<Gandi_Ariana_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
